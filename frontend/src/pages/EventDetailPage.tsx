...
export default function EventDetailPage() {
  ...
  if (loading) {
    return (
      <PageShell>
        <p className="mx-auto max-w-[1440px] px-[6.5rem] py-20 text-center text-gray-400">Loading...</p>
      </PageShell>
    )
  }
  ...
  if (error || !event) {
    return (
      <PageShell>
        <p className="mx-auto max-w-[1440px] px-[6.5rem] py-20 text-center text-red-600">{error || 'Event not found.'}</p>
      </PageShell>
    )
  }
